# Createing MySQL database in AWS for staging environment
...
- go into the subfolder which is this example `cd zero-downtime-deployment/live/stage/data-stores/mysql`.
